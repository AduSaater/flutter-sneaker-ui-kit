...
import 'package:sneakers/screen/SSForgotPasswordScreen.dart';
import 'package:sneakers/screen/SSRegisterScreen.dart';
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          ...
          children: [
            ...
            SizedBox(height: 8),
            Text("Please sign in to continue", textAlign: TextAlign.start, overflow: TextOverflow.clip, style: primaryTextStyle()),
            SizedBox(height: 32),
            TextField(
