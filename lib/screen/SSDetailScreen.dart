            ...
            Padding(
              ...
              child: Column(
                ...
                children: [
                  ...
                  SizedBox(height: 8),
                  Text(
                      "Air Jordan 1 Retro High University Blue sneakersBe careful: there are many reasons to be obsessed with these Air Jordan 1 Retro High sneakers from Jordan, like their contrasting light blue panels to the iconic high-top silhouette that was first debuted by Michael Jordan in 1985. You've been warned, they're a retro classic with a modern edge. ",
            ...
            Expanded(
              child: sSAppButton(
                ...
                onPressed: () {
                  ...
                  Navigator.of(context).pushReplacement(MaterialPageRoute(builder: (context)=>SSCartFragment()));
                    },
              ),
            ),
          ],
