...
List<SneakerShoppingModel> getAllData() {
  ...
  list.add(SneakerShoppingModel(name: 'Nike Air VaporMax Evo', subtitle: 'men\'s shoes', img: 'images/sneakerShopping/ic_shoes_8.png', amount: '\$200.00'));
...
List<SneakerShoppingModel> getSearchData() {
  List<SneakerShoppingModel> list = [];
  list.add(SneakerShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '25% OFF', img: 'images/sneakerShopping/sn1.jpg'));
  list.add(SneakerShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '30% OFF', img: 'images/sneakerShopping/sn2.jpg'));
  list.add(SneakerShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '70% OFF', img: 'images/sneakerShopping/sn3.jpg'));
  list.add(SneakerShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '55% OFF', img: 'images/sneakerShopping/sn4.jpg'));
  list.add(SneakerShoppingModel(name: 'Top & T-Shirt Collection', subtitle: '35% OFF', img: 'images/sneakerShopping/sn5.jpg'));
